...
public class BiMapCollectorTest {
	...
	public void testSupplier(){
		...
		final BiMap<String, String> actual = list.stream().collect( GuavaCollectors.toBiMap(
				HashBiMap::create, KEY_FUNCTION, VALUE_FUNCTION));
	...
	public void testParallel(){
		...
		final BiMap<String, String> expected = list.stream().collect( GuavaCollectors.toBiMap(KEY_FUNCTION, VALUE_FUNCTION));
		final BiMap<String, String> actual = list.parallelStream().collect( GuavaCollectors.toBiMap(
				HashBiMap::create, KEY_FUNCTION, VALUE_FUNCTION));
